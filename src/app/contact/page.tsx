    ...
    <main className="mx-auto w-full max-w-4xl px-4 md:px-6 py-10 md:py-14">
      <div className="rounded-md border border-border bg-card p-6 md:p-8">
        ...
        <section className="mt-7 space-y-3">
          <div>
            ...
            <a
              ...
              className="mt-1 inline-flex text-sm md:text-base text-primary hover:underline"
            >
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3">
          ...
          <Link href="/terms" className="inline-flex rounded-md border border-border px-3 py-2 text-sm hover:bg-muted transition-colors">
            Terms
          </Link>
        </div>
      </div>
